<script>
    ...
    import {crossfade, blur, slide} from "svelte/transition";
...
{#if $todos.length === 0}
    <div class="card flex items-center mb-8 !shadow-none !border-none !bg-white/[0.3] text-white/75" in:slide out:slide>
